      ...
      <main className="election-integrity-page">
        ...
        <section className="page-content">
          <div className="container">
            ...
            {/* Report Form Section */}
            <div id="report-form" className="page-section">
            ...
            {/* Education Section */}
            <div className="page-section">
              <h2>Election Integrity Education</h2>
              <div className="education-grid">
                <div className="education-card">
                  ...
                  <h3>Voter Rights</h3>
                  <p>Learn about your rights as a voter and how to protect them during elections.</p>
                  <ul>
                ...
                <div className="education-card">
                  ...
                  <h3>Poll Watching</h3>
                  <p>Understand how to become an effective poll watcher and monitor election integrity.</p>
                  <ul>
                ...
                <div className="education-card">
                  ...
                  <p>Understand how Hawaii's election systems work to ensure security and transparency.</p>
                  <ul>
